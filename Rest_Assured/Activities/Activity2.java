...
import static org.hamcrest.CoreMatchers.equalTo;
	...
	//        String reqBody = new String(inputJSON.readAllBytes()); -- have to check what's the static import
...
//	            .body(reqBody) // Pass request body from file
	        ...
	        response.then().body("message", equalTo("6790"));
	    ...
	    public void getUserInfo() {
	        ...
	        // Assertion
	        response.then().body("id", equalTo(6790));
	        response.then().body("username", equalTo("alokeshd"));
	        response.then().body("firstName", equalTo("Alokesh"));
	        response.then().body("lastName", equalTo("Case"));
	        response.then().body("email", equalTo("alokeshd@mail.com"));
